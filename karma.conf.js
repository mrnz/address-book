...
module.exports = function(config) {
  config.set({
    ...
    files: [
        ...
        {pattern: 'node_modules/angular-local-storage/dist/angular-local-storage.js', included: false},
        {pattern: 'node_modules/angular-animate/angular-animate.min.js', included: false},
        {pattern: 'www/js/**/*.js', included: false},
        {pattern: 'unit-tests/*.test.js', included: false},
        {pattern: 'unit-tests/**/*.test.js', included: false},
